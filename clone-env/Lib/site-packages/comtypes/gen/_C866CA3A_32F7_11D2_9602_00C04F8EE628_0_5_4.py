...
__all__ = [
    'SPSERIALIZEDRESULT', 'ISpeechPhraseElement',
    'SECFNoSpecialChars', 'DISPID_SLWType', 'eLEXTYPE_LETTERTOSOUND',
    'SDA_No_Trailing_Space', 'ISpeechRecoGrammar',
    'eLEXTYPE_VENDORLEXICON', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpRecognizer', 'SAFTGSM610_44kHzMono', 'SPEI_RESERVED6',
    'SP_VISEME_13', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPPChildren', 'SPVISEMES', 'SLTApp',
    'SPDKL_DefaultLocation', 'SINoise', 'DISPID_SPRuleConfidence',
    ...
    'SPTEXTSELECTIONINFO', 'SVEPhoneme', 'SPEI_SOUND_END',
    'DISPID_SOTCategory', 'DISPID_SpeechBaseStream',
    'SAFT12kHz8BitStereo', 'SPCT_DICTATION', 'SVPNormal',
    'SpeechSpecialTransitionType', 'DISPID_SPEs_NewEnum',
    'eLEXTYPE_RESERVED7', 'SITooLoud', 'DISPID_SPEAudioSizeTime',
    'SAFTGSM610_11kHzMono', 'DISPID_SVDisplayUI',
    'SPINTERFERENCE_NONE', 'DISPID_SRCEPhraseStart',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCEAdaptation', 'SRSActiveAlways',
    'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechGrammarTagUnlimitedDictation', 'SPEI_SENTENCE_BOUNDARY',
    'SDTRule', 'SpeechGrammarRuleStateTransitionType', 'SPFM_CREATE',
    'SAFTExtendedAudioFormat', 'SPXRO_SML', 'SBONone',
    'SpeechUserTraining', 'DISPID_SPEsItem',
    'SpeechPropertyAdaptationOn', 'SITooQuiet', 'SGSExclusive',
    'SREPrivate', 'DISPID_SVAudioOutput', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPPNumberOfElements', 'SAFT32kHz8BitMono',
    'DISPID_SPPEngineConfidence', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SOTMatchesAttributes', 'SPPHRASERULE', 'DISPID_SVPause',
    'SP_VISEME_16', 'DISPID_SRIsShared', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechRecognizer', 'SECFIgnoreCase', 'DISPID_SpeechRecoResult',
    'ISpeechPhraseProperties', 'SPSERIALIZEDPHRASE',
    'SpeechDisplayAttributes', 'SREStateChange', 'ISpRecoCategory',
    'DISPID_SGRsAdd', 'DISPID_SOTCId', 'SAFT11kHz8BitStereo',
    'DISPID_SVWaitUntilDone', 'SPCT_SUB_DICTATION', 'SPSSuppressWord',
    'DISPID_SRRTimes', 'SREInterference', 'SPCATEGORYTYPE',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechPhraseElements',
    'ISpeechAudio', 'ISpResourceManager', 'SAFTCCITT_ALaw_8kHzMono',
    'IInternetSecurityMgrSite', 'SPEI_RESERVED2', 'WAVEFORMATEX',
    'SpObjectTokenCategory', 'SPSHORTCUTTYPE', 'ISpNotifySource',
    'SVP_11', 'DISPID_SDKSetLongValue', 'DISPID_SRSetPropertyString',
    'DISPID_SPAsItem', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechPhraseRule', 'SPRULESTATE',
    'DISPID_SPIGetDisplayAttributes', 'SPSFunction',
    'DISPID_SVSpeakStream', 'Speech_Max_Pron_Length',
    'DISPID_SRCESoundStart', 'SpeechCategoryPhoneConverters',
    'DISPID_SGRName', 'DISPID_SVESentenceBoundary',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSRule', 'SpWaveFormatEx', 'ISpeechGrammarRule',
    'DISPID_SPIGrammarId', 'SAFT24kHz16BitStereo',
    'DISPID_SDKGetBinaryValue', 'ISpeechObjectTokens',
    'DISPID_SpeechPhraseBuilder', 'SVEStartInputStream',
    'ISpMMSysAudio', 'SPEI_TTS_BOOKMARK', 'SITooFast',
    'DISPID_SWFEFormatTag', 'SpeechAudioVolume', 'ISpSerializeState',
    'SVSFlagsAsync', 'SpeechTokenContext', 'SPSNoun', 'SRAImport',
    'SRTSMLTimeout', 'DISPID_SGRsCommitAndSave',
    'DISPID_SMSAMMHandle', 'DISPID_SRRPhraseInfo', 'SVP_17',
    'SRESoundStart', 'ISpeechVoiceStatus', 'STSF_AppData',
    'SVEAudioLevel', 'DISPID_SRRGetXMLErrorInfo', 'SGRSTTEpsilon',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVPriority',
    'DISPID_SRRAlternates', 'SpSharedRecognizer', 'ISpeechRecoResult',
    'SPEI_MIN_SR', 'SpeechTokenIdUserLexicon',
    'SAFTCCITT_uLaw_8kHzStereo', 'STCInprocServer',
    'eWORDTYPE_DELETED', 'SPEVENTENUM', 'SVP_14', 'STSF_FlagCreate',
    'DISPID_SRCState', 'eLEXTYPE_PRIVATE11', 'SAFTADPCM_11kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_RESERVED3',
    'DISPID_SGRAddState', 'DISPID_SRCEFalseRecognition',
    'DISPID_SFSOpen', 'DISPID_SLPsItem', 'SRERequestUI',
    'DISPID_SRIsUISupported', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRsDynamic', 'SPWF_INPUT', 'SPRECOSTATE',
    'DISPID_SPIProperties', 'DISPID_SDKCreateKey',
    'DISPID_SDKEnumKeys', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPIAudioStreamPosition', 'Speech_StreamPos_Asap',
    'SpInprocRecognizer', 'SpeechAudioFormatGUIDWave',
    'SPEI_SOUND_START', 'SP_VISEME_11',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechRetainedAudioOptions', 'SPAS_RUN', 'ISpeechBaseStream',
    'DISPID_SpeechDataKey', 'DISPID_SPRFirstElement',
    'DISPID_SREmulateRecognition', 'SASRun', 'DISPID_SRCRecognizer',
    'DISPID_SGRAttributes', 'DISPID_SPPsCount',
    'ISpeechGrammarRuleStateTransitions', 'SGRSTTWildcard',
    'SVF_None', 'DISPID_SBSRead', 'ISpeechRecoResultDispatch',
    'SpPhoneConverter', 'DISPID_SpeechPhraseElement',
    'SAFT44kHz8BitMono', 'DISPID_SGRSAddWordTransition',
    'SpResourceManager', 'DISPID_SGRsCommit', 'SVEBookmark',
    ...
    'DISPID_SGRsFindRule', 'SPBO_AHEAD', 'SPSHT_NotOverriden',
    ...
    'DISPID_SRCEventInterests', 'DISPID_SVEEnginePrivate', 'SPPS_LMA',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechDataKeyLocation', 'DISPID_SpeechAudioBufferInfo',
    'SpeechGrammarState', 'DISPID_SRCRetainedAudioFormat', 'SLTUser',
    'DISPID_SRGRules', 'DISPID_SFSClose', 'SVP_10',
    'SAFT44kHz8BitStereo', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpGrammarBuilder', 'SpeechInterference', 'SGDSActive',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPRuleId',
    'SpeechDiscardType', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPPConfidence', 'ISpeechAudioFormat', 'SVSFParseMask',
    'SPDKL_CurrentUser', 'DISPID_SPAs_NewEnum', 'DISPID_SPEsCount',
    ...
    'DISPID_SLPLangId', 'SLODynamic', 'DISPID_SPEEngineConfidence',
    'SPWAVEFORMATTYPE', 'SPSMF_SAPI_PROPERTIES',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SMSGetData',
    'DISPID_SpeechRecognizerStatus', 'SGRSTTRule',
    'DISPID_SRAudioInput', 'SPPS_RESERVED3', 'DISPID_SGRClear',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpRecoContext2',
    ...
    'DISPID_SVEBookmark', 'SpeechRecoContextState',
    'DISPID_SOTDisplayUI', 'SVSFParseAutodetect', 'SPRST_INACTIVE',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRsCount', 'DISPID_SpeechLexiconWords', 'eLEXTYPE_APP',
    'SpeechRegistryUserRoot', 'DISPID_SRCreateRecoContext',
    'DISPID_SPPName', 'STCLocalServer', 'DISPID_SOTsCount',
    'SBOPause', 'SpSharedRecoContext', 'SECFIgnoreWidth', 'SPSMF_UPS',
    'ISpObjectTokenCategory', 'DISPID_SVGetAudioOutputs',
    'SDTDisplayText', 'SVSFIsFilename', 'DISPID_SGRSTNextState',
    'DISPID_SPPId', 'SPRST_INACTIVE_WITH_PURGE', 'SVEVoiceChange',
    'DISPID_SRCERequestUI', 'DISPID_SPRDisplayAttributes',
    'SpeechRecognitionType', 'DISPID_SRCEHypothesis',
    'DISPID_SRRTLength', 'ISpeechPhraseElements', 'SPSHORTCUTPAIR',
    ...
    'DISPID_SOTCreateInstance', 'SPRECORESULTTIMES', 'SRSEDone',
    'SGLexical', 'DISPID_SpeechRecoResult2', 'DISPID_SLGenerationId',
    'SVP_6', 'DISPID_SABIBufferSize', 'DISPID_SpeechVoice',
    'SpNotifyTranslator', 'eLEXTYPE_PRIVATE13', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechAudio', 'SAFT24kHz8BitStereo',
    'SPEI_FALSE_RECOGNITION', 'SRADefaultToActive',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRGSetWordSequenceData',
    'SPAUDIOSTATE', 'SpeechCategoryAudioOut', 'SVEPrivate',
    'SPVPRI_NORMAL', 'SPEI_PHONEME', 'DISPID_SPEPronunciation',
    '_SPAUDIOSTATE', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechMemoryStream', 'SpeechVoiceEvents',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRRAudioFormat',
    'SPEI_TTS_PRIVATE', 'DISPID_SPEActualConfidence',
    'SSTTTextBuffer', 'SPPS_Noncontent',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SRARoot',
    'DISPID_SVSRunningState', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpProperties', 'DISPID_SVSpeak', 'DISPID_SAStatus',
    'ISpeechLexiconWord', 'DISPID_SpeechGrammarRules', 'ISpVoice',
    'SAFT22kHz16BitStereo', 'SpShortcut', 'SVP_18',
    'DISPID_SLAddPronunciation', 'DISPID_SVSPhonemeId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRs_NewEnum', 'DISPID_SRRGetXMLResult', 'SPSUnknown',
    'SPEI_UNDEFINED', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SGRSTPropertyValue', 'ISpRecoGrammar2',
    'SPAUDIOBUFFERINFO', 'SASStop', 'DISPID_SVGetProfiles',
    'DISPID_SDKGetlongValue', 'DISPID_SABufferNotifySize',
    'DISPID_SGRSTsItem', 'DISPID_SGRInitialState', 'SPWT_LEXICAL',
    'SAFT22kHz8BitMono', 'SPRST_ACTIVE', 'SAFT16kHz16BitMono',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechTokenShellFolder', 'SVP_3', 'SPXMLRESULTOPTIONS',
    'SAFTADPCM_44kHzStereo', 'SVEAllEvents', 'DISPID_SGRSTWeight',
    'SRTEmulated', 'DISPID_SVVolume', 'SPEI_INTERFERENCE',
    'SREHypothesis', 'SPSHORTCUTPAIRLIST', 'DISPIDSPRG',
    'DISPID_SVGetAudioInputs', 'SP_VISEME_19', 'SAFT8kHz16BitStereo',
    'SSTTDictation', 'SPWORDPRONUNCIATION', 'ISpeechLexiconWords',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRGetPropertyString',
    'DISPID_SRGCmdLoadFromObject', 'SPAUDIOOPTIONS',
    'DISPID_SPRuleChildren', 'DISPID_SVSInputWordPosition',
    'SPINTERFERENCE', 'SPGS_DISABLED', 'ISpeechPhraseInfo',
    'DISPID_SRSCurrentStreamNumber', 'SP_VISEME_0',
    'DISPID_SRCVoicePurgeEvent', 'SPPHRASEPROPERTY', 'SVP_19',
    'ISpStreamFormat', 'SRAORetainAudio', 'DISPID_SAFType',
    'SpeechRuleState', 'DISPID_SLGetPronunciations', 'SVP_2',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPRulesItem',
    'DISPID_SAEventHandle', 'ISpeechLexicon', 'SpAudioFormat',
    'SSFMCreateForWrite', 'SPSHT_EMAIL', 'SVSFPersistXML', 'SVP_15',
    'tagSTATSTG', 'DISPID_SRRRecoContext', 'SPFILEMODE',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVSkip', 'SP_VISEME_6',
    'SSSPTRelativeToCurrentPosition', 'SAFT12kHz8BitMono',
    'SpeechPartOfSpeech', 'SSFMOpenForRead', 'DISPID_SRCPause',
    'DISPID_SRRSaveToMemory', 'SVPAlert', 'SVP_7',
    'DISPID_SPRuleName', 'ISpeechFileStream', 'IEnumSpObjectTokens',
    'SpeechTokenValueCLSID', 'ISpeechRecoContext',
    'SPDKL_LocalMachine', 'SPFM_NUM_MODES', 'SP_VISEME_21', 'SVP_1',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIStartTime',
    'DISPID_SVGetVoices', 'SPLO_STATIC', 'SDTProperty',
    'ISpeechMemoryStream', 'SPAUDIOSTATUS',
    'DISPID_SpeechLexiconProns', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_PRIVATE12', 'SPDKL_CurrentConfig',
    '_ISpeechVoiceEvents', 'SRSEIsSpeaking', 'SRESoundEnd',
    'DISPID_SpeechFileStream', 'SpeechCategoryAudioIn', 'IStream',
    'SVP_0', 'DISPID_SLWPronunciations',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPWT_PRONUNCIATION',
    'SPSEMANTICERRORINFO', 'DISPID_SVEStreamEnd',
    'SSSPTRelativeToEnd', 'SAFTCCITT_ALaw_11kHzMono', 'SPCT_COMMAND',
    'ISequentialStream', 'SP_VISEME_10', 'DISPID_SRRSetTextFeedback',
    'SGDSActiveUserDelimited', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCVoice', 'SpeechRecoProfileProperties', 'SPWF_SRENGINE',
    'ISpPhoneticAlphabetConverter', 'SVEWordBoundary',
    'ISpeechPhraseProperty', 'SPEI_START_INPUT_STREAM',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SRProfile',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechRecoContext', 'SPVOICESTATUS',
    'DISPID_SGRSTText', 'DISPID_SLWsCount',
    'SpeechCategoryRecoProfiles', 'SGPronounciation',
    'DISPID_SGRSTPropertyName', 'SPEI_TTS_AUDIO_LEVEL',
    'SPEI_MAX_TTS', 'SRATopLevel', 'DISPID_SPAPhraseInfo',
    'ISpRecognizer2', 'DISPID_SOTCEnumerateTokens',
    'SAFTADPCM_8kHzStereo', 'SPEI_MIN_TTS', 'SREStreamEnd',
    'DISPID_SRCEBookmark', 'SPWT_DISPLAY', 'ISpeechAudioBufferInfo',
    'SpeechVoiceCategoryTTSRate', 'SpeechCategoryRecognizers',
    'SPEI_START_SR_STREAM', 'DISPID_SRRTStreamTime',
    'SpeechTokenKeyUI', 'SREAdaptation', 'SECFIgnoreKanaType',
    'SPVPRI_ALERT', 'DISPID_SRCEStartStream', 'eLEXTYPE_PRIVATE6',
    'ISpeechAudioStatus', 'SPPS_RESERVED2',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SDKSetBinaryValue',
    'SRTStandard', 'SREStreamStart', 'SPRS_INACTIVE',
    'SAFTGSM610_8kHzMono', 'DISPID_SpeechLexicon',
    'DISPID_SPPs_NewEnum', 'SAFT8kHz16BitMono',
    'DISPID_SVEVoiceChange', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPRS_ACTIVE', 'SpeechAudioFormatType', 'DISPID_SASetState',
    'ISpeechCustomStream', 'SAFT32kHz8BitStereo',
    'SAFT44kHz16BitMono', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SAFGuid', 'ISpeechVoice', 'DISPID_SRGCommit',
    'SPCS_ENABLED', 'DISPID_SRRAudio', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPIGetText', 'ISpeechRecoResult2',
    'DISPID_SGRSTs_NewEnum', 'SPEI_VISEME', 'ISpeechWaveFormatEx',
    'DISPID_SLPPhoneIds', 'Speech_Default_Weight', 'DISPID_SBSWrite',
    'DISPID_SPIRule', 'DISPID_SVRate',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eLEXTYPE_RESERVED9',
    'SECLowConfidence', 'DISPID_SPISaveToMemory',
    'DISPID_SLGetGenerationChange', 'SGDisplay', 'SPWORD',
    'eLEXTYPE_PRIVATE4', 'SPGRAMMARSTATE',
    'SpeechEmulationCompareFlags', 'SVP_16', 'SREAllEvents',
    'DISPID_SAVolume', 'ISpLexicon', 'DISPID_SABIMinNotification',
    'SREFalseRecognition', 'DISPID_SASNonBlockingIO',
    'SAFT11kHz16BitMono', 'DISPID_SVSLastResult',
    'ISpeechResourceLoader', 'SpeechWordType', 'SRCS_Disabled',
    'DISPID_SRGIsPronounceable', 'SP_VISEME_15',
    'SpeechRuleAttributes', 'SPRECOCONTEXTSTATUS',
    'ISpeechLexiconPronunciation', 'DISPID_SRGCmdLoadFromFile',
    'SAFT16kHz8BitStereo', 'DISPID_SGRSTPropertyId',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRSTransitions',
    'DISPID_SpeechPhraseReplacement', 'SPPS_SuppressWord',
    'SpLexicon', 'SAFTADPCM_44kHzMono', 'DISPID_SDKOpenKey',
    'DISPID_SOTCSetId', 'DISPID_SASState', 'eLEXTYPE_PRIVATE20',
    'SAFTADPCM_22kHzStereo', 'SpCompressedLexicon', 'SDKLCurrentUser',
    'DISPID_SRCEEnginePrivate', 'DISPID_SVSInputWordLength',
    '_ISpeechRecoContextEvents', 'SPBOOKMARKOPTIONS',
    'STCInprocHandler', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGDictationSetState', 'SAFTText', 'SAFT8kHz8BitStereo',
    'DISPID_SGRId', 'SpeechRecoEvents', 'DISPID_SRGCmdSetRuleState',
    'SPLOADOPTIONS', 'SPBO_TIME_UNITS', 'ISpRecoContext',
    'SPBO_PAUSE', 'DISPID_SVAudioOutputStream', 'DISPID_SBSFormat',
    ...
    'DISPID_SPRsItem', 'DISPID_SMSADeviceId', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechGrammarRule', 'SPPS_Interjection',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRCResume',
    'DISPID_SpeechPhraseReplacements', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpeechPhraseAlternates', 'SRCS_Enabled',
    'DISPID_SAFGetWaveFormatEx', 'SpCustomStream',
    'SpeechGrammarTagDictation', 'DISPID_SRGetPropertyNumber',
    'SPWORDTYPE', 'DISPID_SOTRemove', 'SAFT16kHz8BitMono',
    'SPGS_EXCLUSIVE', 'DISPID_SPEDisplayText', 'SpeechFormatType',
    'SVSFUnusedFlags', 'SpMMAudioOut', 'SPPS_Unknown',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRSCurrentStreamPosition',
    'SpeechRunState', 'SPEI_HYPOTHESIS', 'ISpEventSource',
    'DISPID_SGRSTType', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGReset', 'SPPS_Function', 'ISpNotifySink',
    'SRTExtendableParse', 'DISPID_SVResume', 'SPEI_MAX_SR',
    'SpeechCategoryAppLexicons', 'DISPID_SLWLangId',
    'STCRemoteServer', 'SpObjectToken', 'eLEXTYPE_PRIVATE19',
    'DISPID_SDKEnumValues', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechTokenKeyAttributes', 'SRAONone',
    'DISPID_SpeechLexiconWord', 'SP_VISEME_12', 'SVF_Stressed',
    'SAFT32kHz16BitMono', 'SRERecognition', 'SAFT48kHz16BitMono',
    'SpeechGrammarWordType', 'SREPropertyStringChange',
    'SPEI_SR_BOOKMARK', 'eLEXTYPE_PRIVATE17', 'SREPhraseStart',
    'ISpPhoneConverter', 'SPEI_REQUEST_UI', 'DISPID_SVEventInterests',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTsCount',
    'SpeechLexiconType', 'DISPID_SMSALineId', 'SP_VISEME_14',
    'SINone', 'SDKLCurrentConfig', 'SpeechTokenKeyFiles',
    'DISPID_SOTId', 'SpeechVisemeFeature', 'SDKLLocalMachine',
    'SPEI_RESERVED5', 'SpMMAudioIn', 'SPSLMA', 'DISPID_SVEAudioLevel',
    'SGSEnabled', 'SP_VISEME_8', 'DISPID_SPPValue',
    'DISPID_SDKDeleteKey', 'ISpPhraseAlt',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPPsItem', 'LONG_PTR', 'SpeechCategoryVoices',
    'DISPID_SPPFirstElement', 'DISPID_SOTGetDescription',
    'ISpeechDataKey', 'DISPID_SRCRequestedUIType',
    'SPWORDPRONOUNCEABLE', 'ISpNotifyTranslator',
    'DISPID_SRCRetainedAudio', 'SPPROPERTYINFO',
    'DISPID_SPEAudioTimeOffset', 'SAFT24kHz8BitMono',
    'DISPID_SWFEBlockAlign', 'DISPID_SPCIdToPhone', 'DISPID_SPRText',
    'DISPID_SPERequiredConfidence', 'SPPS_Noun', 'DISPID_SRGState',
    'SAFT48kHz8BitMono', 'DISPID_SOTRemoveStorageFileName',
    'SAFTADPCM_8kHzMono', 'SDTAll', 'SP_VISEME_3', 'DISPID_SGRsItem',
    'SpeechBookmarkOptions', 'DISPID_SASCurrentDevicePosition',
    'SAFT8kHz8BitMono', 'SASPause', 'SPPS_Verb',
    'SpUnCompressedLexicon', 'DISPID_SABIEventBias',
    'DISPID_SpeechPhraseProperty', 'SDA_One_Trailing_Space',
    'SPCT_SUB_COMMAND', 'ISpXMLRecoResult', 'SpeechRecognizerState',
    'SREPropertyNumChange', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechPhraseInfo', 'SGDSInactive',
    'SPINTERFERENCE_TOOLOUD', 'SpeechAudioFormatGUIDText',
    'DISPID_SPRuleFirstElement', 'SPEVENTSOURCEINFO', 'SVSFIsNotXML',
    'SVP_21', 'DISPID_SPRulesCount', 'DISPID_SVSVisemeId',
    ...
    'DISPID_SRRecognizer', 'DISPID_SPACommit',
    'SPEI_SR_RETAINEDAUDIO', 'SPSModifier', 'SPCT_SLEEP', 'SVSFIsXML',
    'DISPID_SpeechGrammarRuleStateTransitions', 'ISpRecoResult',
    'SAFT11kHz16BitStereo', 'SDA_Consume_Leading_Spaces',
    'eLEXTYPE_MORPHOLOGY', 'ISpObjectWithToken',
    'DISPIDSPTSI_SelectionOffset', 'ISpAudio', 'DISPID_SRCBookmark',
    'ISpeechGrammarRuleState', 'DISPID_SVEPhoneme', 'ISpStream',
    'SPPS_RESERVED1', 'SWTDeleted', 'DISPID_SDKDeleteValue',
    'SAFTCCITT_uLaw_22kHzMono', 'SGDSActiveWithAutoPause',
    ...
    'ISpRecoGrammar', 'SPDATAKEYLOCATION', 'SPEI_SR_PRIVATE',
    'ISpEventSink', 'DISPID_SOTGetAttribute', 'SP_VISEME_4',
    'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE7', 'SSSPTRelativeToStart',
    'SECHighConfidence', 'DISPIDSPTSI', 'DISPID_SPIReplacements',
    'SRSActive', 'SPSVerb', 'SDTAlternates',
    'DISPID_SpeechLexiconPronunciation', 'SPINTERFERENCE_TOOQUIET',
    'SPEVENT', 'SPGS_ENABLED', 'DISPID_SLPPartOfSpeech', 'SVP_4',
    ...
    'SLOStatic', 'SVP_9', 'SPRST_NUM_STATES', 'SVEViseme', 'SVP_20',
    'SpeechAddRemoveWord', 'DISPID_SOTs_NewEnum', 'SP_VISEME_1',
    'DISPID_SPRuleParent', 'ISpeechPhraseRules', 'DISPID_SOTDataKey',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPPParent',
    'SPPHRASEREPLACEMENT', 'DISPID_SPRsCount', 'SpeechLoadOption',
    'SVP_8', 'SPAS_CLOSED', 'SPVPRI_OVER', 'DISPID_SRCEEndStream',
    'eLEXTYPE_RESERVED8', 'DISPID_SOTsItem', 'SVSFDefault',
    'DISPID_SRGRecoContext', 'SREAudioLevel', 'SPEI_VOICE_CHANGE',
    'SPSHT_OTHER', 'DISPID_SOTCDefault', 'SAFT48kHz16BitStereo',
    'DISPID_SGRs_NewEnum', 'ISpeechPhoneConverter', 'DISPID_SRStatus',
    'SRERecoOtherContext', 'SPSEMANTICFORMAT',
    'SPEI_RECO_STATE_CHANGE', 'SVSFNLPSpeakPunc',
    'DISPID_SRGetFormat', 'SAFT22kHz16BitMono', 'SAFT11kHz8BitMono',
    'DISPID_SVStatus', 'SP_VISEME_9', 'DISPID_SpeechXMLRecoResult',
    'SP_VISEME_17', 'DISPIDSPTSI_ActiveOffset',
    'SPINTERFERENCE_NOSIGNAL', 'SpInProcRecoContext',
    'SVEEndInputStream', 'DISPID_SVSLastBookmarkId',
    'SPFM_CREATE_ALWAYS', 'SAFTADPCM_22kHzMono', '_RemotableHandle',
    'DISPID_SRCEPropertyStringChange', 'SRAExport',
    'DISPID_SVIsUISupported', 'ISpDataKey', 'SDTAudio',
    'SPCONTEXTSTATE', 'SWPUnknownWordPronounceable', 'SVPOver',
    'DISPID_SASCurrentSeekPosition', 'SAFT16kHz16BitStereo',
    'SPINTERFERENCE_TOOFAST', 'SPLEXICONTYPE',
    'ISpStreamFormatConverter', 'DISPID_SRCEInterference',
    'DISPID_SCSBaseStream', 'SRTReSent',
    'DISPID_SRGCmdLoadFromResource', 'SPVPRIORITY',
    'DISPID_SADefaultFormat', 'DISPID_SRCCreateGrammar',
    'SRTAutopause', 'eLEXTYPE_RESERVED6', 'DISPID_SVVoice',
    'SAFT12kHz16BitMono', 'SpVoice', 'DISPID_SBSSeek',
    'DISPID_SpeechPhraseAlternates',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SGRSTRule',
    'SPPARTOFSPEECH', 'SpeechAllElements', 'SPPS_Modifier',
    'DISPID_SOTIsUISupported', 'DISPID_SRCERecognition',
    'SpFileStream', 'SPADAPTATIONRELEVANCE', 'SpStream', 'SPAR_High',
    'DISPID_SPANumberOfElementsInResult', 'SFTInput',
    'DISPID_SMSSetData', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVP_12', 'SpeechMicTraining', 'DISPID_SVSLastBookmark',
    'SPEI_END_SR_STREAM', 'SECFDefault', 'SPPS_RESERVED4',
    'eLEXTYPE_USER', 'SSFMOpenReadWrite', 'SPAR_Medium',
    'DISPID_SLWsItem', '__MIDL_IWinTypes_0009', 'DISPID_SWFEChannels',
    'SASClosed', 'SVSFNLPMask', 'SpeechVoiceSpeakFlags',
    'eLEXTYPE_PRIVATE10', 'SAFTCCITT_ALaw_11kHzStereo',
    'SSTTWildcard', 'STSF_CommonAppData', 'SPEI_END_INPUT_STREAM',
    'DISPID_SWFEExtraData', 'SPRST_ACTIVE_ALWAYS',
    'Speech_Max_Word_Length', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRTTickCount', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SLWs_NewEnum', 'SVSFParseSsml',
    'Speech_StreamPos_RealTime', 'SPEI_PHRASE_START',
    'SAFTCCITT_ALaw_44kHzMono', 'SDKLDefaultLocation',
    'DISPID_SWFESamplesPerSec', 'ISpeechPhraseRule', 'SPAR_Unknown',
    'SRSInactiveWithPurge', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SpeechPhraseRules', 'eWORDTYPE_ADDED',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SASFreeBufferSpace',
    'ISpeechXMLRecoResult', 'SRAInterpreter',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SLPs_NewEnum',
    'DISPID_SRGId', 'SREBookmark', 'SVSFVoiceMask',
    'DISPID_SPIElements', 'SPEI_WORD_BOUNDARY', 'SPAR_Low',
    'SAFTNonStandardFormat', 'SECFEmulateResult',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCEAudioLevel',
    'DISPID_SGRAddResource', 'SPGRAMMARWORDTYPE',
    'DISPID_SPRNumberOfElements', 'SAFT24kHz16BitMono',
    'IInternetSecurityManager', 'SAFTDefault', 'SP_VISEME_5',
    'SPXRO_Alternates_SML', 'DISPID_SVEWord', 'SPRECOGNIZERSTATUS',
    'SpMMAudioEnum', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_PRIVATE2', 'DISPID_SPIEngineId', 'SVF_Emphasis',
    'ISpeechObjectToken', 'SP_VISEME_18', 'SPBINARYGRAMMAR',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRRSpeakAudio',
    'ISpPhrase', 'SP_VISEME_20', 'SpeechStreamFileMode', 'SVP_5',
    'SpPhoneticAlphabetConverter', 'SDTReplacement',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SGRSAddSpecialTransition',
    'SDTPronunciation', 'SVP_13', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechAudioStatus',
    'SpeechStreamSeekPositionType', 'SRADynamic', 'SGRSTTDictation',
    'SPAS_STOP', 'SpeechEngineProperties', 'ISpShortcut',
    'SPCS_DISABLED', 'DISPID_SPAsCount', 'SAFT32kHz16BitStereo',
    'DISPID_SLPSymbolic', 'DISPID_SRSetPropertyNumber',
    'SAFT44kHz16BitStereo', 'SAFTCCITT_uLaw_11kHzMono',
    'SPSHT_Unknown', 'SVESentenceBoundary',
    ...
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE9', 'IEnumString',
    'SpeechGrammarTagWildcard', 'DISPID_SPCPhoneToId',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SLPType', 'SPPHRASE',
    'DISPID_SLGetWords', 'ISpeechTextSelectionInformation',
    'SPPHRASEELEMENT', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechPhoneConverter', 'ISpeechRecognizerStatus',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRGDictationLoad',
    'SpeechVoicePriority', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechVoiceEvent',
    'SDTLexicalForm', 'SPBO_NONE', 'DISPID_SRState',
    'SPFM_OPEN_READWRITE', 'SPAO_NONE', 'SGRSTTTextBuffer',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_PRIVATE14',
    'SSFMCreate', 'DISPID_SPILanguageId', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPAS_PAUSE', 'SpeechVisemeType', 'ISpeechPhraseInfoBuilder',
    'SPWORDLIST', 'SVSFParseSapi',
    'SpeechPropertyComplexResponseSpeed', 'SVSFPurgeBeforeSpeak',
    'SpeechEngineConfidence', 'SpNullPhoneConverter',
    'SpeechAudioState', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechObjectTokens', 'SP_VISEME_7', 'DISPID_SLPsCount',
    'SINoSignal', 'DISPID_SRGetRecognizers', 'SP_VISEME_2',
    'SPEI_ADAPTATION', 'SPEI_RECOGNITION', 'SITooSlow',
    'DISPID_SOTCGetDataKey', 'ISpeechGrammarRules',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SABufferInfo', 'SFTSREngine',
    'SPRULE', 'SpMemoryStream', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_PRIVATE1', 'SGSDisabled', 'DISPID_SRRTOffsetFromStart',
